...
function HeroSection() {
  return (
    <div className="flex flex-col-reverse md:flex-col-reverse lg:flex-row md:justify-between items-center mt-[0px] lg:mt-[72px] lg:mb-[103px] mb-[71px] md:px-20 px-[28px] w-full">
