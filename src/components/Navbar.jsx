...
function Navbar() {
      ...
      <div className="flex items-center justify-between w-full">
        ...
        <div className="hidden lg:block ">
          <ul className="flex gap-3 md:gap-5 lg:gap-7 text-[12px] md:text-[14px] lg:text-[16px] font-light cursor-pointer">
            <li className="text-[#0F0F0F] hover:text-[#693B93] hover:font-[700]">Home</li>
            <li className="text-[#0F0F0F] hover:text-[#693B93] hover:font-[700]">About</li>
            <li className="text-[#0F0F0F] hover:text-[#693B93] hover:font-[700]">Services</li>
            <li className="text-[#0F0F0F] hover:text-[#693B93] hover:font-[700]">Technology</li>
            <li className="text-[#0F0F0F] hover:text-[#693B93] hover:font-[700]">FAQs</li>
          </ul>
        </div>
  ...
  <button  onClick={() => setSel(!sel)} className="flex items-center w-[135px] md:w-[115px] lg:w-[125px] h-[44px] md:h-[40px] lg:h-[42px] justify-evenly rounded-[8px] border border-[#693B93] bg-[#F9F3FF] text-[#0F0F0F] font-visby font-semibold text-[14px]">
    ...
    <span className="text-[14px] md:text-[13px] lg:text-[14px]">{lang.name}</span>
  ...
  {sel && ( <div className="flex flex-col mt-3 absolute z-50 border border-[#693B93] right-13.5 top-13 items-center w-[150px] py-[14px] pl-[10px] pr-[50px] rounded-[8px] bg-[#F9F3FF] text-[#0F0F0F] font-visby font-semibold text-[14px]">
        <button   onClick={() => {
      ...
      {menuOpen && (
        <div className="absolute top-full left-0 w-full z-100 bg-white shadow-md flex flex-col items-start lg:hidden p-4 px-[32px] md:px-20 gap-3 z-50">
          <ul className="flex flex-col gap-3 text-[14px] font-light cursor-pointer w-full">
            <li className="text-[#0F0F0F] hover:text-[#693B93] hover:font-[700] w-full border-b border-gray-200 pb-2">Home</li>
            <li className="text-[#0F0F0F] hover:text-[#693B93] hover:font-[700] w-full border-b border-gray-200 pb-2">About</li>
            <li className="text-[#0F0F0F] hover:text-[#693B93] hover:font-[700] w-full border-b border-gray-200 pb-2">Services</li>
            <li className="text-[#0F0F0F] hover:text-[#693B93] hover:font-[700] w-full border-b border-gray-200 pb-2">Technology</li>
            <li className="text-[#0F0F0F] hover:text-[#693B93] hover:font-[700] w-full border-b border-gray-200 pb-2">FAQs</li>
          </ul>
